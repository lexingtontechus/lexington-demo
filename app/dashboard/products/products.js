...
const products = [
  ...
  },
  {
    ...
    technology:
      "Custom scalable technology solutions that integrate with your existing platform.",
  ...
  },
  {
    ...
    consultingmanagement:
      "Strategic modeling of your organization & future technology requirements.",
    projectmanagement:
      "Our Professional Services team can help your business bring ideas to market quickly.",
        ...
        >
          <div className="card-body items-center text-center">
            ...
            <ul className="text-xs list-disc list-outside text-left">
              <li>
                <span>Consulting Management</span> - {item.consultingmanagement}
              </li>
              <li>
