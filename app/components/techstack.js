...
const stripeLogo = ({ src, width, quality }) => {
  ...
  return (
    <div className="drawer">
      ...
      <div className="drawer-side">
        <label htmlFor="techstack_drawer" className="drawer-overlay"></label>
        ...
        <ul className="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
          ...
          <span className="p-4 text-sm text-left">
            Showcase peerless performance, efficiency and developer experience.
          </span>
          ...
          <span className="p-4 text-sm text-left">
            ...
            (Utility-first CSS framework) for all common UI components. Adding
            component class names to Tailwind CSS make beautiful websites faster
            than ever.
          </span>
          <li className="text-2xl font-semibold">
            <Link
          ...
          <span className="p-4 text-sm text-left">
            B2B SaaS Authentication & User Management with prebuilt NextJS UI
            components
          </span>
          <li className="text-2xl font-semibold">
            <Link
          ...
          <span className="p-4 text-sm text-left">
            Stripe Developers Elements UI & Checkout
          </span>
          <li className="text-2xl font-semibold">
            <Link
